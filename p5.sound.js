...
newOSC = function () {
    ...
    var oscBuffer = function (name, tableSize) {
        this.name = name;
        // required for constructor, no default
        this.tableSize = tableSize || 2048;
    ...
    p5.prototype.Osc = function (name, tableSize) {
        ...
        this._phaseOffset = 0;
        // if phase is reset while buffer is playing
        this.playing = false;
        // stereo panning
        this.panPosition = 0;
        this.panner = p5sound.audiocontext.createPanner();
...
src_app = function () {
    ...
    var p5SOUND = sndcore;
    return p5SOUND;
}(sndcore, master, helpers, soundfile, amplitude, fft, oscillator, pulse, lfo, noise, audioin, env, distortion, newOSC);
}());